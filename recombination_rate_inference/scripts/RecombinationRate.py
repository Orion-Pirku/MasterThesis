...
recombination_rate = read_files_parallel("recombination_rate_inference/output/n50_*_W100_P20.rmap")
...
plot_genome_wide_rho(windows_10kb)
...
plot_rho_distribution(windows_10kb)
