...
def plot_pop_gen_stats(
    ...
    if n_chromosomes == 1:
        ...
        for i, chrom in enumerate(chromosomes):
            ...
            ax = axes[i]
            ax.plot(x, y, color=plotLineColor, lw=1)
            ax.set_xlabel(f"Chromosome {str(chrom).replace('chr', '')}",
...
def plot_score_strength_per_chrom(
    ...
    if pct.empty:
        ...
        ax.axis("off")
        ax.text(0.5, 0.5, "No numeric scores to plot.", ha="center", va="center", fontsize=12)
